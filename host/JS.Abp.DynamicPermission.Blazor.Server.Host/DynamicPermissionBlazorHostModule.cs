...
using JS.Abp.DynamicPermission.Blazor.Server.Host.Components;
using JS.Abp.DynamicPermission.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(DynamicPermissionBlazorServerModule)
)]
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(DynamicPermissionDomainModule).Assembly,
                typeof(DynamicPermissionDomainSharedModule).Assembly,
                typeof(DynamicPermissionApplicationModule).Assembly,
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("DynamicPermission");
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles(new BundleFile("/JS.Abp.DynamicPermission.Blazor.Server.Host.styles.css", true));
                }
            );
        });
