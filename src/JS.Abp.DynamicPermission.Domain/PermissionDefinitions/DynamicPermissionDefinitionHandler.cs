...
public class DynamicPermissionDefinitionHandler: ILocalEventHandler<EntityChangedEventData<PermissionDefinition>>,IUnitOfWorkEnabled,ITransientDependency
{
    ...
    public DynamicPermissionDefinitionHandler(IGuidGenerator guidGenerator, IPermissionGroupDefinitionRecordRepository permissionGroupDefinitionRecordRepository, IPermissionDefinitionRecordRepository permissionDefinitionRecordRepository, IDynamicPermissionDefinitionStoreInMemoryCache storeCache)
    {
